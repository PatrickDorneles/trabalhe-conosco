...
describe('ProducersController', () => {
  ...
  describe('GET /producers/:id', () => {
    it('should get a producer by id', async () => {
      ...
      const response = await request(app.getHttpServer())
        .get('/producer/123e4567-e89b-12d3-a456-426614174000')
        .expect(200);
  ...
  describe('PATCH /producers/:id', () => {
    it('should update a producer', async () => {
      ...
      const response = await request(app.getHttpServer())
        .patch('/producer/123e4567-e89b-12d3-a456-426614174000')
        .send(dto)
        .expect(200);
  ...
  describe('DELETE /producers/:id', () => {
    it('should delete a producer', async () => {
      ...
      await request(app.getHttpServer())
        .delete('/producer/123e4567-e89b-12d3-a456-426614174000')
        .expect(204);
    });
  });
});
